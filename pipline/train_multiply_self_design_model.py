...
x_train,x_valid,y_train,y_valid,cov_train,cov_test,depth_train,depth_test = \
                            k_folds_raw(train_df,K_flods,padd = upsample_128,img_size=image_size,
...
for i in range(1,6):
    ...
    output_layer = build_model_self_design(input_layer, 16, 0.5)
    ...
    f = open('/home/zhangs/lyc/salt/code/logs10.11.txt',"a+")
