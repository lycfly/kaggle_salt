...
class SnapshotCallbackBuilder:
    ...
    def get_callbacks(self, model_prefix='Model',monitor='val_acc',mode='max'):
        """
        ...
        callback_list = [callbacks.ModelCheckpoint("weights/%s-Best.h5" % model_prefix, monitor=monitor,mode=mode,
