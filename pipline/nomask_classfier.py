...
# 模型训练
# save_path = '../trained_models/single_res34_transpose_dp02.model'
# history_all = []
# num_of_flods =1
# for i in range(num_of_flods):
#     fig, axs = plt.subplots(num_of_flods, 2, squeeze=False,figsize=(15, 5))
#
#     model = Unet(input_shape=(256,256,3),decoder_filters=(256,128,64,32,16),backbone_name='resnet34',
#                  encoder_weights='imagenet',decoder_block_type='transpose',
#                  freeze_encoder=False,decoder_use_batchnorm=True,dp=0.2,sp_dp=0)
